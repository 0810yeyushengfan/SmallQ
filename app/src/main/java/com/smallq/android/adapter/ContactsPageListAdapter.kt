...
//
//        when {
//            node.getLayoutResId() == R.layout.contacts_group_item -> {
//                //group node
//                val info= node.getData() as GroupInfo
//                val gvh = viewHoler as GroupViewHolder
//                gvh.textViewTitle.text = info.title
//                gvh.textViewCount.text = info.onlineCount.toString()+"/"+node.getChildrenCount()
//            }
//            node.layoutResId == R.layout.contacts_contact_item -> {
//                //child node
//                val info = node.getData() as ContactInfo
//                val cvh = viewHoler as ContactViewHolder
//                //cvh.imageViewHead.setImageBitmap(info.avatar)
//                cvh.textViewTitle.text = info.name
//                cvh.textViewDetail.text = info.status
//            }
//        }
//    }
//
